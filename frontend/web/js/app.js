$(function () {
    ...
    function initComment($comment) {
        ...
        function onCommentPin(ev) {
            ...
            if (pinned) {
                if (!confirm("Вы уверены, что хотите открепить комментарий?")) {
                    return;
                }
            } else {
                if (!confirm("Вы хотите закрепить комментарий. Вы уверенны, что хотите открепить предыдущий?")) {
                    return;
                }
            }
    ...
    function onDeleteClick(ev) {
        ...
        if (confirm('Вы уверенны, что хотите удалить данный комментарий?')) {
            $.ajax({
                method: 'post',
